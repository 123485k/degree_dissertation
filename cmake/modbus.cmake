...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} ${MODBUS_DIR}/configure  --srcdir=${MODBUS_DIR} --host=${CMAKE_SYSTEM_PROCESSOR} --prefix=${MODBUS_BIN} --disable-tests
